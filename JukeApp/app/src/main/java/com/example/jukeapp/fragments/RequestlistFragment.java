...
import com.example.jukeapp.databinding.FragmentRequestlistBinding;
import com.example.jukeapp.databinding.FragmentWhitelistBinding;
import com.example.jukeapp.fragments.api.Song;
import com.example.jukeapp.viewmodels.RequestlistViewModel;
...
public class RequestlistFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(RequestlistViewModel.class);
        viewModel.mSongs.observe(getViewLifecycleOwner(), new Observer<List<Song>>() {
            ...
            public void onChanged(List<Song> songs) {
                ...
                binding.rcyRequestlist.setLayoutManager(new LinearLayoutManager(getContext()));
                binding.rcyRequestlist.setAdapter(songAdapter);
                binding.rcyRequestlist.setHasFixedSize(true);
                binding.progressBar.setVisibility(View.GONE);
                binding.btnGo2WhiteListR.setOnClickListener(new View.OnClickListener() {
                    @Override
                ...
                binding.btnGo2BlackListR.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (songAdapter.mIdSeleccionat != -1) {
