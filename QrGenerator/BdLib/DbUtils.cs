...
namespace BdLib
{
    public class DbUtils
    {
        ...
        public static void afegirParametre(DbCommand comanda, String nomParametre, object valorParametre, DbType tipus)
        {
        ...
        public static T? readDb<T>(DbDataReader reader, string columna) where T : struct
        {
            ...
            if (!reader.IsDBNull(reader.GetOrdinal(columna)))
            {
                ...
                {
                    throw new Exception("Me estàs jodiendo (tipus no suportat)");
                }
                return valor;
            }
            else return null;
        ...
        public static long countRows(String nomtaula)
        {
            try
            {
        ...
        public static T readDbc<T>(DbDataReader reader, string columna) where T : class
        {
